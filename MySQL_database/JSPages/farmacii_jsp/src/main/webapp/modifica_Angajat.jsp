...
<body>
    ...
    <h1 class="text-center">MODIFICA TABELA ANGAJATI</h1>
    <br>
            ...
            <div class="col-md-12">
                <form action="" method="post">
                    <div class="text">
                        ...
                        <input type="submit" class="btn btn-primary " value="Adauga un nou angajat" formaction="nou_Angajat.jsp">
                        <input type="submit" class="btn btn-primary " value="Modifica linia marcata" formaction="m1_Angajat.jsp">
                        <input type="submit" class="btn btn-primary " value="Sterge liniile marcate" formaction="sterge_Angajat.jsp">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            %>
                            <tr>
                                <td><input type="checkbox" name="primarykey" value="<%= rs.getInt("idAngajat") %>"></td>
                                <td><%= rs.getInt("idAngajat") %></td>
