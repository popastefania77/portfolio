...
<body>
    ...
    <h1 class="text-center">MODIFICA TABELA FARMACII</h1>
    <br>
            ...
            <div class="col-md-12">
                <form action="" method="post">
                    <div class="text">
                        ...
                        <input type="submit" class="btn btn-primary " value="Adauga o noua farmacie" formaction="nou_Farmacie.jsp">
                        <input type="submit" class="btn btn-primary " value="Modifica linia marcata" formaction="m1_Farmacie.jsp">
                        <input type="submit" class="btn btn-primary " value="Sterge liniile marcate" formaction="sterge_Farmacie.jsp">
