...
<body>
	<header>
        ...
        <%
            ...
            if (Denumire != null) {
                jb.connect();
                jb.adaugaFarmacie(Denumire, Telefon, Sediu);
                jb.disconnect();
        %>
        ...
        <form action="nou_Farmacie.jsp" method="post">
            <table>
                <tr>
                    <td align="right">Denumire Farmacie:</td>
                    <td> <input type="text" name="Denumire" size="40" /></td>
                </tr>
                <tr>
                    <td align="right">Telefon Farmacie:</td>
                    <td> <input type="text" name="Telefon" size="30" /></td>
                </tr>
                <tr>
                    <td align="right">Sediu Farmacie:</td>
                    <td> <input type="text" name="Sediu" size="30" /></td>
                </tr>
            </table>
